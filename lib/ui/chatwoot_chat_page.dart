...
// import 'package:chatwoot_sdk_support/chatwoot_client.dart';
...
// import 'package:chatwoot_sdk_support/ui/chatwoot_chat_theme.dart';
// import 'package:chatwoot_sdk_support/ui/chatwoot_l10n.dart';
...
//   ) {
//     final index = _messages.indexWhere((element) => element.id == message.id);
//     final updatedMessage = _messages[index].copyWith(repliedMessage: message);
...
//               child: Chat(
//                 // messages: _messages,
//                 currentUserId: "${DateTime.now().microsecond}",
//                 resolveUser: "123",
//                 chatController: null,
//                 // onMessageTap: (context, message, {TapUpDetails details, int index}) =>  _handleMessageTap(context, message),
